      ...
      <div className="flex items-center space-x-0.5 sm:space-x-1 shrink-0">
        ...
        {user ? (
          <button
            type="button"
            onClick={() => syncNow()}
            className="flex items-center space-x-1 p-1.5 sm:px-2 sm:py-1 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-300 border border-emerald-200/60 dark:border-emerald-800/60 text-xs font-semibold hover:bg-emerald-100 transition"
            title={`Compte Neon connecté (${user.email}) - Cliquez pour synchroniser`}
          >
            {syncStatus === 'syncing' ? (
          ...
          <Link
            href="/connexion"
            className="flex items-center space-x-1 p-1.5 sm:px-2 sm:py-1 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-200/60 dark:border-slate-700/60 text-xs font-semibold hover:bg-emerald-50 hover:text-emerald-700 hover:border-emerald-200 transition"
            title="Connexion / Sauvegarde Cloud Neon"
          >
            <User className="h-3.5 w-3.5" />
            <span className="hidden sm:inline text-[11px]">Connexion</span>
          </Link>
        )}
